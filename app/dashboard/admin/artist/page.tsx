                                ...
                                <DialogContent className="bg-gray-700">
                                    ...
                                    <div className="grid gap-2 py-4">
                                        <div className="flex items-center gap-2">
                                            <Label htmlFor="name" className="text-white w-20">Name</Label>
                                            <Input
                                                value={newArtistInfo.name}
                                                id="name"
                                                className="flex-1 text-white border-gray-500"
                                                onChange={(e) => setNewArtistInfo({ ...newArtistInfo, name: e.target.value })}
                                            />
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <Label htmlFor="bio" className="text-white w-20 mt-2">Bio</Label>
                                            <textarea
                                                ...
                                                onChange={(e) => setNewArtistInfo({ ...newArtistInfo, bio: e.target.value })}
                                            />
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Label htmlFor="profileImage" className="text-white w-20">Image</Label>
                                    ...
                                    <DialogFooter>
                                        ...
                                        <Button className="hover:bg-gray-500" onClick={handleAddArtist}>Lưu</Button>
                                    </DialogFooter>
                                </DialogContent>
                            </Dialog>
                        </div>
                        ...
                        <Table className="w-full table-fixed">
                            ...
                            <TableBody>
                                {loading && loadTimeExceeded ? (
                                    ...
                                    [...artists, ...Array(Math.max(0, 10 - artists.length)).fill(null)].map((artist, index) => (
                                        <TableRow key={index} className="hover:bg-gray-700 h-10 border-gray-400">
                                            {artist ? (
                                                <>
                                                    <TableCell className="font-medium w-[20%] truncate">{shortId(artist._id)}</TableCell>
                                                    ...
                                                    <TableCell className="text-right w-[10%]">
                                                        <Dialog>
                                                            <DialogTrigger asChild onClick={() => handleUpdate(artist._id)}>
                                                                <Pencil size={15} className="text-gray-400 hover:text-white cursor-pointer ml-auto" />
                                                            </DialogTrigger>
                                                            <DialogContent className="bg-gray-700">
                                                                <DialogHeader>
                                                                    <DialogTitle className="text-white">Chỉnh sửa nghệ sĩ</DialogTitle>
                                                                    <DialogDescription className="text-gray-300">
                                                                        Nhập vào các trường dữ liệu sau đó bấm vào lưu để cập nhật nghệ sĩ.
                                                                    </DialogDescription>
                                                                </DialogHeader>
                                                                <div className="grid gap-2 py-4">
                                                                    <div className="flex items-center gap-2">
                                                                        <Label htmlFor="id" className="text-white w-20">ID</Label>
                                                                        <Input value={artistInfo.id} id="id" className="flex-1 text-white border-gray-500" disabled />
                                                                    </div>
                                                                    <div className="flex items-center gap-2">
                                                                        <Label htmlFor="name" className="text-white w-20">Name</Label>
                                                                        <Input value={artistInfo.name} id="name" className="flex-1 text-white border-gray-500" onChange={handleChange} />
                                                                    </div>
                                                                    <div className="flex items-start gap-2">
                                                                        <Label htmlFor="bio" className="text-white w-20 mt-2">Bio</Label>
                                                                        <textarea
                                                                ...
                                                                <DialogFooter className="flex justify-between w-full">
                                                                    <div className="flex justify-start w-full">
                                                                        <Dialog>
                                                                            ...
                                                                            <DialogContent className="bg-gray-700">
                                                                                <DialogHeader>
                                                                                    <DialogTitle className="text-white">Xác nhận xóa nghệ sĩ</DialogTitle>
                                                                                    <DialogDescription className="text-gray-300">
                                                                                        Bạn có chắc chắn muốn xóa nghệ sĩ "{artistInfo.name}" không? Hành động này không thể hoàn tác.
                                                                                    </DialogDescription>
                                                                                </DialogHeader>
                                                                                <DialogFooter>
                                                                                    <DialogClose asChild>
